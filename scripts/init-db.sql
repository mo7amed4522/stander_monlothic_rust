-- Car Lift Database Initialization Script
...
-- Grant necessary permissions (using postgres user as configured in docker-compose)
-- GRANT statements removed as application connects with postgres user
